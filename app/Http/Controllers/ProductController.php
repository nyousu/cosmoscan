...
class ProductController extends Controller
{
    ...
    public function show(Request $JANcode)
    {
        ...
        if ($cnt == 1 && $JANcode == "4901872964613") {
            return $url1;
        } else if ($cnt == 1 && $JANcode == "9784802611848") {
            return $url2;
        } else if ($cnt == 1 && $JANcode == "494567890123") {
            return $url3;
        } else if ($cnt == 1 && $JANcode == "495678901234") {
            return $url4;
        } else if ($cnt == 1 && $JANcode == "496789012345") {
            return $url5;
        } else if ($cnt == 1 && $JANcode == "497890123456") {
            return $url6;
        } else if ($cnt == 1 && $JANcode == "498901234567") {
            return $url7;
        } else if ($cnt == 1 && $JANcode == "499012345678") {
            return $url8;
        } else if ($cnt == 1 && $JANcode == "499123456789") {
            return $url9;
        } else if ($cnt == 1 && $JANcode == "499234567890") {
            return $url10;
        } else {
            return "該当する商品はありません";
        }
